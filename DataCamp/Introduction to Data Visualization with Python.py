...
#         Draw the arrow by specifying the keyword argument arrowprops=dict(facecolor='black').
...
plt.subplot(2,2,1)
plt.contourf(X,Y,Z,20, colormap='viridis')
plt.pcolorbar()
plt.title('Viridis')

# Create a filled contour plot with a color map of 'gray'
plt.subplot(2,2,2)
plt.contourf(X,Y,Z,20, colormap='gray')
plt.pcolorbar()
plt.title('Gray')

# Create a filled contour plot with a color map of 'autumn'
plt.subplot(2,2,3)
plt.contourf(X,Y,Z,20, colormap='autumn')
plt.pcolorbar()
plt.title('Autumn')

# Create a filled contour plot with a color map of 'winter'
plt.subplot(2,2,4)
plt.contourf(X,Y,Z,20, colormap='winter')
plt.pcolorbar()
plt.title('Winter')
...
#         To force a higher order regression, you need to specify the order parameter.
