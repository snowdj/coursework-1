...
#     Assign column 0 of points - points[:,0] - to xs.
#     Assign column 1 of points - points[:,1] - to ys.
...
#     Create a KMeans instance called model to find 3 clusters.
...
## 2 - Visualization with hierarchical clustering
...
#         KMeans from sklearn.cluster.
#         make_pipeline from sklearn.cluster.
...
#     Use the .iloc[] accessor on the DataFrame to select row number 3. Assign the result to component.
...
#     Import matplotlib.pyplot as plt.
#     Select row 0 of samples and assign the result to digit.
...
# Now use what you've learnt about NMF to decompose the digits dataset. You are again given the digit images as a 2D array samples. This time, you are also provided with a function show_as_image() that displays the image encoded by any 1D array.
...
# Instructions
    ...
    # Import PCA from sklearn.decomposition.
    # Create an PCA instance called model with 7 components.
    # Apply the .fit_transform() method of model to samples. Assign the result to features.
    # To each component of the model (accessed via model.components_), apply the show_as_image() function to that component inside the loop.
...
# In the video, you learnt how to use NMF features and the cosine similarity to find similar articles. Apply this to your NMF model for popular Wikipedia articles, by finding the articles most similar to the article about the footballer Cristiano Ronaldo. The NMF features you obtained earlier are available as nmf_features, while titles is a list of the article titles.
# Instructions
